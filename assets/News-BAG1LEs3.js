import{M as w}from"./index-BMSQkwth.js";import{f as C,s as R,$ as _,v as l,x as a,G as v,d as h,u as y,q as N,H as k,n as d,F as g,P as c,Q as m,R as f,O as u,_ as P,l as B,o as A,W as T,Y as $,Z as M}from"./index-Lixa1wv7.js";function D(o){const{textColor1:t,dividerColor:r,fontWeightStrong:s}=o;return{textColor:t,color:r,fontWeight:s}}const H={name:"Divider",common:C,self:D},O=R("divider",`
 position: relative;
 display: flex;
 width: 100%;
...
`,[_("vertical",`
 ...
 width: 100%;
 margin: 0;
 `),_("dashed",[l("line",{backgroundColor:"var(--n-color)"})]),a("dashed",[l("line",{borderColor:"var(--n-color)"})]),a("vertical",{backgroundColor:"var(--n-color)"})]),F=Object.assign(Object.assign({},v.props),{titlePlacement:{type:String,default:"center"},dashed:Boolean,vertical:Boolean}),L=h({name:"Divider",props:F,setup(o){const{mergedClsPrefixRef:t,inlineThemeDisabled:r}=y(o),s=v("Divider","-divider",O,H,o,t),i=N(()=>{const{common:{cubicBezierEaseInOut:n},self:{color:p,textColor:b,fontWeight:x}}=s.value;return{"--n-bezier":n,"--n-color":p,"--n-text-color":b,"--n-font-weight":x}}),e=r?k("divider",void 0,i,o):void 0;return{mergedClsPrefix:t,cssVars:r?void 0:i,themeClass:e==null?void 0:e.themeClass,onRender:e==null?void 0:e.onRender}},render(){var o;const{$slots:t,titlePlacement:r,vertical:s,dashed:i,cssVars:e,mergedClsPrefix:n}=this;return(o=this.onRender)===null||o===void 0||o.call(this),d("div",{role:"separator",class:[`${n}-divider`,this.themeClass,{[`${n}-divider--vertical`]:s,[`${n}-divider--no-title`]:!t.default,[`${n}-divider--dashed`]:i,[`${n}-divider--title-position-${r}`]:t.default&&r}],style:e},s?null:d("div",{class:`${n}-divider__line ${n}-divider__line--left`}),!s&&t.default?d(g,null,d("div",{class:`${n}-divider__title`},this.$slots),d("div",{class:`${n}-divider__line ${n}-divider__line--right`})):null)}}),z=`# 柏拉图：寻求终极的真理与实在
...
格劳孔为了让自己的观点更有力，讲了一个魔戒的故事。这个故事说的是，一个名叫裘格斯的牧羊人发现了一枚戒指，它赋予了他一种魔法般的力量，使他可以随意隐身。格劳孔问，拥有这样力量的人，如果他们知道了，自己永远都不会被逮住，永远都不会被指认出来，那谁会有道德力量去抵制偷盗、杀戮、通奸或其他不道德恶行的诱惑？为了扩展这一思想实验，格劳孔接着让我们想象两个人。一个人是完全不正义的、邪恶的，另一个人是完全正义的。不过，那个邪恶的人（非常聪明）成功地欺骗了他的社会，做着我们所能想到的最肮脏的恶行，却获得了无瑕的美誉。相反，社会完全误解了那个善人。虽然他是完全善的，但他的社会错误地把邪恶的声誉强加到他头上，由此而迫害他、折磨他。在上述情况下，有什么理由要做个正义的人呢？做个邪恶的人不是更好吗？这样还可以受到时人的羡慕和尊敬，得到社会的各种好处。我们可以进一步扩展格劳孔的问题，进一步问，“如果不存在来世或天堂，以奖励我们的善行，那有什么理由要做个正义的人呢？”这些考虑难道没有清楚地表明，做个好人的唯一理由，正义所具有的唯一价值，仅仅在于它所带来的好名声和外在利益（此生的或者来生的）？格劳孔在总结其发言的时候，向苏格拉底提出了如下的挑战：
...
`,J=`# Hello,my friend
`,K={class:""},S=["innerHTML"],q=h({__name:"New",props:{title:{},content:{}},setup(o){const t=w(),r=o,s=t.render(r.content);return(i,e)=>(c(),m("div",K,[f("div",{innerHTML:u(s),class:"content mt-6 .dark:text-white"},null,8,S)]))}}),Q=P(q,[["__scopeId","data-v-37d26c1b"]]),Z={class:"sm:mx-10 lg:mx-30 mt-8 mx"},en=h({__name:"News",setup(o){const t=B([]);async function r(){const s=Object.assign({"/src/assets/News/1-4-0-柏拉图：寻求终极的真理与实在.md":z,"/src/assets/News/1-4-1-柏拉图生平：从学生到大学校长.md":W,"/src/assets/News/1-4-2-柏拉图的任务：全面发展哲学.md":j,"/src/assets/News/1-4-3-知识论：理性对意见.md":V,"/src/assets/News/1-4-4-形而上学：阴影与实在.md":E,"/src/assets/News/1-4-5-道德理论.md":G,"/src/assets/News/1-4-6-政治理论.md":I,"/src/assets/News/1-4-7-柏拉图的宇宙论：意图与偶然.md":U,"/src/assets/News/1-4-8-评价与意义.md":Y,"/src/assets/News/file1.md":J});for(const i of Object.keys(s)){console.log(i);const e=s[i];let n=i.split("/").pop()||"";n=n.split(".")[0],console.log(n),t.value.push({fileName:n,content:e})}}return A(async()=>{await r()}),(s,i)=>(c(),m("div",Z,[i[0]||(i[0]=f("header",{class:"text-3xl font-bold dark:text-white"},"News",-1)),T(u(L)),(c(!0),m(g,null,$(t.value,e=>(c(),M(Q,{title:e.fileName,content:e.content},null,8,["title","content"]))),256))]))}});export{en as default};
